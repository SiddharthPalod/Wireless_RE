...
def run():
    ...
    np.save("training_rewards.npy", np.array(rewards_hist, dtype=np.float32))
    np.save("training_losses.npy", np.array(losses_hist, dtype=np.float32))
    np.save("training_actions.npy", np.array(actions_hist, dtype=np.int32))
